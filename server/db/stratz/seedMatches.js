...
const getMatchesFromLeague = require('./getMatchesByLeague');

 // For testing purposes
const league = {
    id: 14388,
    name: 'ESL One Malaysia',
    description: 'Powered by Intel',
    patch: '7.31d'
}


// This function no longer works due to changes in the db, need to refactor
